...
├─ Account.java // Stores individual account information and manages transactions
├─ Bank.java // Manages multiple accounts using HashMap
├─ Machine.java // ATM machine logic: card insertion, authentication, menu navigation
├─ UserValidator.java // Static methods for input validation
